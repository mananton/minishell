...
/*   Updated: 2025/10/13 14:26:29 by mananton         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					apply_redirs_parent(const t_redir *r, int *saved_in,
						int *saved_out, int *fd_in, int *fd_out, t_env *env);
void				restore_stdio_parent(int saved_in, int saved_out, int fd_in,
						int fd_out);
...
char				*read_token(const char *s, size_t start, size_t end,
						size_t len, const char *status, size_t status_len,
						t_env *env);
